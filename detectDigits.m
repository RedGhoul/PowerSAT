...
peaksFound = findpeaks(energySignal(1,:),'MinPeakDistance',200,'Annotate','extents','WidthReference','halfheight')
maxPeak = max(peaksFound) 
% You know that the first energy signal is for things with a Hz of only
% 100Hz
% you know that the since there are three humps there are 3 digits present
